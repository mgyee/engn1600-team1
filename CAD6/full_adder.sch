...
N 760 -310 760 -270 {lab=#net8}
N 690 -340 720 -340 {lab=#net4}
N 690 -340 690 -240 {lab=#net4}
N 690 -240 720 -240 {lab=#net4}
N 1020 -310 1020 -270 {lab=#net8}
N 760 -300 1020 -300 {lab=#net8}
N 1020 -390 1020 -370 {lab=#net9}
N 1020 -470 1020 -450 {lab=#net10}
N 1020 -130 1020 -110 {lab=#net11}
N 1020 -210 1020 -190 {lab=#net12}
N 1020 -50 1020 -30 {lab=VSS}
N 1020 -550 1020 -530 {lab=VDD}
N 1190 -190 1190 -170 {lab=COUT}
N 1190 -180 1220 -180 {lab=COUT}
N 1020 -300 1220 -300 {lab=#net8}
...
N 1280 -350 1280 -330 {lab=SUM}
N 1280 -340 1310 -340 {lab=SUM}
N 1280 -380 1290 -380 {lab=VDD}
N 1290 -420 1290 -380 {lab=VDD}
N 1280 -420 1290 -420 {lab=VDD}
N 1280 -420 1280 -410 {lab=VDD}
N 1280 -300 1290 -300 {lab=VSS}
N 1290 -300 1290 -260 {lab=VSS}
N 1280 -260 1290 -260 {lab=VSS}
N 1280 -270 1280 -260 {lab=VSS}
N 1280 -260 1280 -250 {lab=VSS}
N 1280 -430 1280 -420 {lab=VDD}
N 1220 -300 1240 -300 {lab=#net8}
N 1220 -380 1240 -380 {lab=#net8}
N 1220 -380 1220 -300 {lab=#net8}
...
C {code_shown.sym} 200 -580 0 0 {name=s1 only_toplevel=false value="
.param kSUMb=1
.param kTS=1
"}
C {symbols/pfet_03v3.sym} 1260 -380 0 0 {name=M27
L=0.28u
W=0.72u
nf=1
m=1
...
C {symbols/nfet_03v3.sym} 1260 -300 0 0 {name=M28
L=0.28u
W=0.36u
nf=1
m=1
...
C {lab_wire.sym} 1280 -430 0 0 {name=p12 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 1280 -250 0 0 {name=p14 sig_type=std_logic lab=VSS}
C {opin.sym} 1310 -340 0 0 {name=p15 lab=SUM}
