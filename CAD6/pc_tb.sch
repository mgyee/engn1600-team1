...
C {lab_pin.sym} 150 -30 0 1 {name=p11 lab=SO}
C {lab_pin.sym} 150 -10 0 1 {name=p12 lab=PC[15..0]}
...
C {devices/vsource.sym} -1440 350 1 0 {name=VCLK value=0}
C {devices/lab_pin.sym} -1410 350 2 0 {name=pCLK lab=CLK}
C {devices/gnd.sym} -1470 350 1 0 {name=gCLK}
C {devices/vsource.sym} -1440 250 1 0 {name=VRSTn value=3.3}
C {devices/lab_pin.sym} -1410 250 2 0 {name=pRSTn lab=RSTn}
C {devices/gnd.sym} -1470 250 1 0 {name=gRSTn}
