...
C {ipin.sym} -50 -20 0 0 {name=p3 lab=SEL}
...
C {iopin.sym} -50 0 2 0 {name=p5 lab=VDD}
C {iopin.sym} -50 20 2 0 {name=p6 lab=VSS}
C {lab_wire.sym} 90 -10 2 1 {name=p10 lab=VSS}
C {lab_pin.sym} -50 -20 2 0 {name=p12 lab=SEL}
C {lab_pin.sym} -50 0 2 0 {name=p14 lab=VDD}
C {lab_pin.sym} -50 20 2 0 {name=p15 lab=VSS}
