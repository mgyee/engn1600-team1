...
N 300 -260 300 -200 {lab=VSS}
N 300 -340 300 -280 {lab=VDD}
...
N 300 100 300 160 {lab=VSS}
N 300 20 300 80 {lab=VDD}
N -60 280 -60 340 {lab=VSS}
N -60 200 -60 260 {lab=VDD}
N 120 280 120 340 {lab=VSS}
N 120 200 120 260 {lab=VDD}
N 300 280 300 340 {lab=VSS}
N 300 200 300 260 {lab=VDD}
...
C {lab_pin.sym} 260 -310 2 1 {name=p31 lab=S0b}
C {lab_pin.sym} 300 -200 0 0 {name=p45 lab=VSS}
C {symbols/pfet_03v3.sym} 280 -310 2 1 {name=M3
L=0.28u
W=0.36u
nf=1
m=1
...
C {symbols/nfet_03v3.sym} 280 -230 0 0 {name=M5
L=0.28u
W=0.36u
nf=1
m=1
...
C {lab_pin.sym} 260 -230 2 1 {name=p48 lab=S0b}
C {lab_pin.sym} 300 -340 2 1 {name=p49 lab=VDD}
...
C {lab_pin.sym} 260 -130 2 1 {name=p34 lab=S1b}
C {lab_pin.sym} 300 -20 0 0 {name=p35 lab=VSS}
C {symbols/pfet_03v3.sym} 280 -130 2 1 {name=M11
L=0.28u
W=0.72u
nf=1
m=2
...
C {lab_pin.sym} 260 -50 2 1 {name=p36 lab=S1b}
C {lab_pin.sym} 300 -160 2 1 {name=p37 lab=VDD}
...
C {lab_pin.sym} 260 50 2 1 {name=p47 lab=S2b}
C {lab_pin.sym} 300 160 0 0 {name=p50 lab=VSS}
C {symbols/pfet_03v3.sym} 280 50 2 1 {name=M17
L=0.28u
W=0.36u
nf=1
m=4
...
C {symbols/nfet_03v3.sym} 280 130 0 0 {name=M18
L=0.28u
W=0.36u
nf=1
m=4
...
C {lab_pin.sym} 260 130 2 1 {name=p51 lab=S2b}
C {lab_pin.sym} 300 20 2 1 {name=p52 lab=VDD}
...
C {lab_pin.sym} 260 230 2 1 {name=p61 lab=S3b}
C {lab_pin.sym} 300 340 0 0 {name=p62 lab=VSS}
C {symbols/pfet_03v3.sym} 280 230 2 1 {name=M23
L=0.28u
W=0.72u
nf=1
m=8
...
C {symbols/nfet_03v3.sym} 280 310 0 0 {name=M24
L=0.28u
W=0.36u
nf=1
m=8
...
C {lab_pin.sym} 260 310 2 1 {name=p63 lab=S3b}
C {lab_pin.sym} 300 200 2 1 {name=p64 lab=VDD}
