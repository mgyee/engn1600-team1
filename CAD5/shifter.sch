...
bus=true}
C {engn1600-team1/CAD5/2x1_mux_cmos.sym} 0 -300 3 1 {name=x1[15..0] kI=1 kYb=1 kY=1}
...
C {engn1600-team1/CAD5/2x1_mux_cmos.sym} 0 -100 3 1 {name=x3[15..0] kI=1 kYb=1 kY=1}
...
C {lab_pin.sym} 10 -140 0 1 {name=p30 lab=X[13..0],VSS*2}
C {engn1600-team1/CAD5/2x1_mux_cmos.sym} 0 100 3 1 {name=x4[15..0] kI=1 kYb=1 kY=1}
...
C {engn1600-team1/CAD5/2x1_mux_cmos.sym} 0 300 3 1 {name=x5[15..0] kI=1 kYb=1 kY=1}
...
C {lab_pin.sym} 10 260 0 1 {name=p42 lab=Z[7..0],VSS*8}
C {lab_pin.sym} -10 340 3 0 {name=p43 lab=Q[15..0]}
