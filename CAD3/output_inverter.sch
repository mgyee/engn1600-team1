...
S {}
E {}
N 210 -260 230 -260 {lab=QBb}
N 210 -260 210 -160 {lab=QBb}
N 210 -160 230 -160 {lab=QBb}
N 270 -230 270 -190 {lab=QB}
...
N 270 -210 310 -210 {lab=QB}
N 190 -210 210 -210 {lab=QBb}
N 210 -540 230 -540 {lab=QAb}
N 210 -540 210 -440 {lab=QAb}
N 210 -440 230 -440 {lab=QAb}
N 270 -510 270 -470 {lab=QA}
...
N 270 -490 310 -490 {lab=QA}
N 190 -490 210 -490 {lab=QAb}
...
C {opin.sym} 310 -210 0 0 {name=p2439 lab=QB}
...
C {opin.sym} 310 -490 0 0 {name=p2503 lab=QA}
C {iopin.sym} 90 -700 2 0 {name=p2 lab=VDD}
C {iopin.sym} 90 -660 2 0 {name=p1 lab=VSS}
C {ipin.sym} 190 -490 0 0 {name=p3 lab=QAb}
C {ipin.sym} 190 -210 0 0 {name=p4 lab=QBb}
