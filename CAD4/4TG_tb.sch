...
C {vsource.sym} -700 50 0 0 {name=V4 value=0 savecurrent=false}
...
C {lab_wire.sym} -650 20 0 0 {name=p20 sig_type=std_logic lab=S2
}
C {lab_wire.sym} -600 20 0 0 {name=p21 sig_type=std_logic lab=S3
}
...
"}
C {engn1600-team1/CAD4/4TG.sym} 0 0 0 0 {name=x1}
C {lab_pin.sym} -150 -70 0 0 {name=p1 lab=A}
C {lab_pin.sym} -150 -50 0 0 {name=p2 lab=B}
C {lab_pin.sym} -150 -30 0 0 {name=p3 lab=C}
C {lab_pin.sym} -150 -10 0 0 {name=p4 lab=D}
C {lab_pin.sym} -150 10 0 0 {name=p5 lab=S0}
C {lab_pin.sym} -150 30 0 0 {name=p6 lab=S1}
C {lab_pin.sym} -150 50 0 0 {name=p7 lab=S2}
C {lab_pin.sym} -150 70 0 0 {name=p8 lab=S3}
C {lab_pin.sym} 150 -70 0 1 {name=p9 lab=OUT}
C {lab_pin.sym} 150 -50 0 1 {name=p10 lab=VDD}
C {lab_pin.sym} 150 -30 0 1 {name=p11 lab=VSS}
